...
const NavListItem = ({children, to, onClick}) => {
	return (
		<li>
			<a href={to ? to : null} onClick={onClick} className="
				text-veryDarkBlue cursor-pointer font-bold lg:text-darkGrayishBlue lg:hover:text-veryDarkBlue lg:font-normal
